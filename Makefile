...
PACKAGE ?= helm-knative-operator
XRD_DIR := apis/knativeoperators
COMPOSITION := $(XRD_DIR)/composition.yaml
DEFINITION := $(XRD_DIR)/definition.yaml
EXAMPLE_DEFAULT := examples/knativeoperators/standard.yaml
...
EXAMPLES := \
    examples/knativeoperators/minimal.yaml:: \
    examples/knativeoperators/standard.yaml::
...
render\:%:
	@example="examples/knativeoperators/$*.yaml"; \
	up composition render --xrd=$(DEFINITION) $(COMPOSITION) $$example
